...
def createtransform(func):
    ...
    The class generated by this decorator is automatically inserted into the transform registry.
...
class RegisterTransformClass:
    ...
    def __call__(self, cls):
        if self.class_id in transform_registry:
            raise KeyError('Transform class {cls} already exists in registry.'
                           .format(cls=self.class_id))

        transform_registry[self.class_id] = cls
        return cls
