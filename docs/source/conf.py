...
# -*- coding: utf-8 -*-
#
# Dynamic Gravity Processor documentation build configuration file, created by
...
# Link shortcuts - see: http://www.sphinx-doc.org/en/stable/ext/extlinks.html
extlinks = {}

# Intersphinx Mapping to link to external sphinx documentation
intersphinx_mapping = {
...
# See: https://github.com/MSLNZ/msl-qt/blob/master/docs/create_pyqt_objects.py
...
# Set sort type for auto documented members, select from 'alphabetical',
# 'groupwise', or 'bysource'
autodoc_member_order = 'bysource'

# Autodoc directives automatically applied
autodoc_default_flags = ['members']

# -- Options for Doc Coverage extension -----------------------------------
